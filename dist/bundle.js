...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_obj_str__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__button_css__ = __webpack_require__(26);
...
function _defineProperty(obj,key,value){if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:true,configurable:true,writable:true});}else{obj[key]=value;}return obj;}console.log(__WEBPACK_IMPORTED_MODULE_3__button_css__["default"]);function Button(_ref){var _objstr;var size=_ref.size,inverse=_ref.inverse,icon=_ref.icon,children=_ref.children;var style=Object(__WEBPACK_IMPORTED_MODULE_2_obj_str__["a" /* default */])((_objstr={},_defineProperty(_objstr,__WEBPACK_IMPORTED_MODULE_3__button_css__["default"],true),_defineProperty(_objstr,__WEBPACK_IMPORTED_MODULE_3__button_css__["default"].inverse(),inverse),_defineProperty(_objstr,__WEBPACK_IMPORTED_MODULE_3__button_css__["default"].size(size),true),_objstr));return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('button',{'class':style},icon&&__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span',{'class':__WEBPACK_IMPORTED_MODULE_3__button_css__["default"].icon},icon),children);}__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Button,null),document.getElementById('app'));
